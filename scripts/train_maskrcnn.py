...
from consentguard.config import load_training_config
from consentguard.perception.models import build_instance_segmentation_model, model_summary
from consentguard.perception.trainer import MaskRCNNTrainer, build_data_loaders
from consentguard.runtime import environment_snapshot, seed_everything, select_device


def main() -> None:
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--config", default="configs/train_maskrcnn_4gb.yaml")

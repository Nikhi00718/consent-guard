...
| 03 — Specialists | Adapter complete, optional providers gated | Mask R-CNN evidence adapter and sequential orchestrator are implemented and tested; optional specialist weights and licensed training data remain external gates. |

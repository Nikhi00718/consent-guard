...
from consentguard.shared.runtime import atomic_json_dump, environment_snapshot
...
def main() -> None:
    ...
    parser.add_argument("--config", default="main_project/configs/stage_02_baseline_model/train_smoke.yaml")
